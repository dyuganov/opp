...
void calculate_center(double layer_height, double* prev_Phi, double* Phi, int rank, bool* flag)
{
...
void  calculate_edges(int layer_height, double* prev_Phi, double* Phi, int rank, bool* flag, double* down_layer, double* up_layer, int proc_num)
{
    double x_component, y_component, z_component;
...
void calc_max_difference(int rank, int layer_height, double* Phi )
{
    double max = 0;
    double diff = 0;
...
int main(int argc, char** argv)
{
    ...
    while (delta_larger_eps)
    {
        ...
        calculate_center(layer_height, prev_Phi, Phi, rank, &delta_larger_eps);
        ...
        calculate_edges(layer_height, prev_Phi, Phi, rank, &delta_larger_eps, down_layer, up_layer, proc_num);
    ...
    calc_max_difference(rank, layer_height, Phi);
